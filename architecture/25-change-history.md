...
| 2026-07-17 | EPIC-003 | §10 | Default views refresh shipped. Added `src/router/Inbox.route.tsx`, wired `/inbox` to a real route and bottom-nav item in `src/router/routes.tsx`/`src/router/AppShell.view.tsx`, and added route membership checks to the standard task test graph. |
