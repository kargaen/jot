...
import { useReminderWindowShell } from "../../../../hooks/useReminderWindowShell";
...
export default function ReminderWindow() {
  ...
  const {
    pin, onStart, opacity, secondsLeft, paused, relax, hiddenAreaIds, progress, urgent, color, pulseStyle,
    shellBg, surfaceBg, surfaceBorder, shellShadow, dismiss, snooze, togglePin, toggleOnStart,
    setOpacityPreference,
  } = useReminderWindowShell({ userPresent: Boolean(user), isManual, loaded, tasks, projects });
    ...
    >
      ...
      <div style={{ flexShrink: 0, borderTop: `1px solid ${surfaceBorder}`, padding: "7px 12px", background: surfaceBg }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 5 }}>
          ...
          <Toggle on={onStart} onToggle={toggleOnStart} />
        </div>
        {/* Opacity row */}
          <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 7 }}>
            ...
            <input
              ...
              value={opacity}
              onChange={(e) => setOpacityPreference(parseFloat(e.target.value))}
          ...
          <>
            <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 6 }}>
              ...
              <span style={{
                ...
                color: paused ? "var(--text-tertiary)" : urgent ? "var(--priority-high)" : "var(--text-secondary)",
                ...pulseStyle,
              }}>
